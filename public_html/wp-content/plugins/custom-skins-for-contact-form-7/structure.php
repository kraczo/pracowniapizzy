<input type="hidden" value="<?php echo CF7CT_PLUGIN_URI;?>" id='path' >
<div class="wrap">
	...
	?>
	<h2 ><?php	echo esc_html( __( 'Contact Form 7 Form Skins', 'cf7ct' ) );?></h2>
	<div class="top_div">
		...
		<div class="stngcntinr">		
			...
			<form id="setting_form">
				...
				<div class="bottom_div">
					<input type="hidden" id="cf7ct_id" name="cf7ct_id" onchange="return load_css(this.value);" >
