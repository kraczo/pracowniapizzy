...
define( 'WPCACHEHOME', '/usr/home/kraczo/domains/pracownia-pizzy.pl/public_html/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
define('DB_NAME', 'kraczo_wordpres');

/** Nazwa użytkownika bazy danych MySQL */
define('DB_USER', 'kraczo_wordpres');

/** Hasło użytkownika bazy danych MySQL */
define('DB_PASSWORD', 'Pracowniapizzy1');
...
define('WP_HOME', 'http://pracownia-pizzy.pl');
define('WP_SITEURL', 'http://pracownia-pizzy.pl');
